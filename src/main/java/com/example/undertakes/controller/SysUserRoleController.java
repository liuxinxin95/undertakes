...
public class SysUserRoleController {
    ...
    public Result list(@RequestBody Map<String, Object> params) {
        //查询列表数据
        PageInfo<SysUserRole> pageInfo = PageHelper.startPage(MapUtils.getInteger(params, "page"),
                MapUtils.getInteger(params, "limit")).doSelectPageInfo(() -> sysUserRoleService.queryList(params));
    ...
    public Result info(@PathVariable("id") Long id) {
        ...
        return Result.ok().put("sysUserRole", sysUserRole);
    }
    ...
    public Result delete(@RequestBody Long[]ids) {
        try {
            if (ids.length == 1) {
                    sysUserRoleService.delete(ids[0]);
            } else {
